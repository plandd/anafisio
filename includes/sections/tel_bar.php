...
<section class="call-us-bar bg-primary small-12 left show-for-large-up">
  <div class="d-table small-12 left">
    <div class="small-12 d-table-cell">
      <div class="row">
        <header class="small-5 columns">
          <h6 class="white no-margin">Deixe seu nome e telefone que ligamos para você</h6>
          <h6 class="info no-margin">Se preferir, ligue para a gente 11-5631-0206</h6>
        </header>
